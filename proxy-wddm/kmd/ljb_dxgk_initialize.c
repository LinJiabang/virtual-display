...
static CONST DRIVER_INITIALIZATION_DATA_WIN7    DriverInitTableWin7 =
{
    ...
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_DispatchIoRequest,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_InterruptRoutine,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_DpcRoutine,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_QueryChildRelations,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_QueryChildStatus,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_QueryDeviceDescriptor,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_SetPowerState,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_NotifyAcpiEvent,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_ResetDevice,
    ...
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_QueryAdapterInfo,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_CreateDevice,
    NULL, // NOT YET IMPLEMENTED &LJB_DXGK_CreateAllocation,
