/*!
    \file       lci_vmon_internal_ioctl.c
    \brief      VMON Internal IOCTL implementation.
    \details    VMON Internal IOCTL Implementation.
    \authors    lucaslin
    \version    0.01a
    \date       July 25, 2013
    \todo       (Optional)
...
LJB_VMON_InternalDeviceIoControl(
    ...
    switch(IoControlCode)
        {
    case INTERNAL_IOCTL_LCI_ACQUIRE_AV_INTERFACE:
    ...
    case INTERNAL_IOCTL_LCI_RELEASE_AV_INTERFACE:
        InterlockedDecrement(&pDevCtx->InterfaceReferenceCount);
